...
<div class="wallet-outer">
    <div class="wallet-wrap1">
        <div class="wallet-row1">
            ...
            <div class="wallet-row1-third d-flex">
                <div>
        ...
        <div class="modal-content modal-content-wt">
            ...
            <div class="modal-body modal-body-wt">
                ...
                <div id="turnover_body">
                    <!-- <div class="wt-wrap" style="border-bottom:2px dotted rgba(0,0,0,0.2);">
                        <div class="wt-form">
                        ...
                        <div class="wt-form">
                            ...
                            <div class="wt-form-dl">
                                <span>50% Welcome Bonus For Slot Games</span>
                            </div>
                        </div>
                        <div class="wt-form">
                            <div class="wt-form-tl">
                            ...
                            <div class="wt-form-dl">
                                <span>55.00 / 350.00</span>
                            </div>
                        </div>
                        <div class="wt-reminder">
                            <i class="fas fa-exclamation-circle"></i>&nbsp;<span class="wt_reminder language" data-translate="reminder-wt">May take few
                            minutes to be update!</span>
                        </div>
                    </div>
                    <div class="wt-wrap">
                        <div class="wt-form">
...
<div class="w-50 py-2 text-center d-flex justify-content-start language" data-translate="game_wallet" style="font-weight:500;">Game
Wallet</div>
<span class="close-sumpopup" data-dismiss="modal" aria-label="Close"><i class="fal fa-times" aria-hidden="true"></i></span>
</div>
...
$(function() {
    ...
    if (/deposit/.test(loc)) {
        ...
        $('.deposit_non_selected').css("display", "none");
        $('.deposit_selected').css("display", "block");
    } else if (/transfer/.test(loc)) {
        $('#transfer-page').addClass('active');
        $('.transfer_non_selected').css("display", "none");
        $('.transfer_selected').css("display", "block");
    } else if (/withdraw/.test(loc)) {
        $('#withdraw-page').addClass('active');
        $('.withdrawal_non_selected').css("display", "none");
        $('.withdrawal_selected').css("display", "block");
    } else if (/promotion/.test(loc)) {
        $('#promotion-page').addClass('active');
        $('.promo_non_selected').css("display", "none");
        $('.promo_selected').css("display", "block");
    } else if (/history/.test(loc)) {
        $('#history-page').addClass('active');
        $('.history_non_selected').css("display", "none");
        $('.history_selected').css("display", "block");
    } else {
